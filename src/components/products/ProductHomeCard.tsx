...
export function ProductHomeCard({
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -inset-3 opacity-0 rounded-md bg-card transition-all transition-150 group-hover:opacity-100 group-hover:shadow-[0_0_10px_rgba(0,0,0,0.18)]"
      />
      <div
