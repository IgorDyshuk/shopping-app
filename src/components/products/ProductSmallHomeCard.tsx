...
export function ProductSmallHomeCard({ product }: ProductCardProps) {
    ...
    >
      ...
      <div className="relative z-10 flex h-full w-full flex-col gap-2 pr-0">
        <div className="relative flex h-full w-full flex-col gap-2">
          ...
          <div className="relative py-6 sm:py-8 px-3 sm:px-6 xl:px-4 xl:mb-1 w-full rounded-sm bg-[#f0f0f3] md:bg-[#f7f7f7] flex justify-center">
            <img
              src={product.image}
              alt={product.title}
